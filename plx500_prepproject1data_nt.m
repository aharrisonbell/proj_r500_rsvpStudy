...
unit_index.pref_excite=unit_index.pref_excite(pointer);
unit_index.pref_inhibit=unit_index.pref_inhibit(pointer);
...
for g=1:numgrids,
    ...
    data(g).face_trad=[]; data(g).face_trad_nofruit=[]; 
 ...
 % Per Grid Measures
    ...
    excitecounts_nofruit=sum(data(g).countsmat_nofruit,1);
    ...
    inhibitcounts_nofruit=sum(data(g).countsmatI_nofruit,1);
    ...
    bothcounts_nofruit=sum(data(g).countsmatB_nofruit,1);
    ...
    data(g).countsB=sum(data(g).countsmatB,1);
