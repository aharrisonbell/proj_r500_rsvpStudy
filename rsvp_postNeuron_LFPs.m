function rsvp_postNeuron_LFPs(monkinitial,preexist);
%%%%%%%%%%%%%%%%%%%%%%%%
% rsvp_postNeuron_LFPs %
%%%%%%%%%%%%%%%%%%%%%%%%
% written by AHB, May2009,
% based on plx500_project1_LFPs - adapted to analyze LFP responses (population).
% Specific for analysis following unsuccessful Neuron Application :)
...
disp('************************************************************************')
disp('* rsvp_postNeuron_LFPs.m - Generates figures listed under Project 1 in *')
